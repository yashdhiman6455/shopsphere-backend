...
<head>
    ...
    <style>
        ...
        .order-box { background: #f5f3ff; border: 1px solid #ddd6fe; border-radius: 8px; padding: 20px; margin: 20px 0; }
        .order-box p { margin: 5px 0; }
        .order-box .label { font-weight: 700; color: #4f46e5; }
...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>You can download your invoice anytime from your account dashboard.</p>
